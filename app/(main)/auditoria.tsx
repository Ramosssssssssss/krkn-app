...
const menuItems = [
  { id: 'auditorias', title: 'Auditorías', subtitle: 'Listado de auditorías', icon: 'clipboard-outline' },
  { id: 'nueva', title: 'Nueva Auditoría', subtitle: 'Crear auditoría', icon: 'add-circle-outline' },
  { id: 'hallazgos', title: 'Hallazgos', subtitle: 'Resultados encontrados', icon: 'flag-outline' },
  { id: 'historial', title: 'Historial', subtitle: 'Auditorías anteriores', icon: 'time-outline' },
];
