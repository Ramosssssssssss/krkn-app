...
const menuItems = [
  { id: 'pedimentos', title: 'Pedimentos', subtitle: 'Gestión de pedimentos', icon: 'document-text-outline' },
  { id: 'facturas', title: 'Facturas', subtitle: 'Facturas de importación', icon: 'receipt-outline' },
  { id: 'aranceles', title: 'Aranceles', subtitle: 'Clasificación arancelaria', icon: 'list-outline' },
  { id: 'agentes', title: 'Agentes Aduanales', subtitle: 'Directorio de agentes', icon: 'people-outline' },
];

export default function AduanaScreen() {
