...
const menuItems = [
  { id: 'generar', title: 'Generar Reporte', subtitle: 'Crear nuevo reporte', icon: 'add-outline' },
  { id: 'programados', title: 'Programados', subtitle: 'Reportes automáticos', icon: 'calendar-outline' },
  { id: 'historial', title: 'Historial', subtitle: 'Reportes generados', icon: 'time-outline' },
  { id: 'plantillas', title: 'Plantillas', subtitle: 'Formatos predefinidos', icon: 'copy-outline' },
];
