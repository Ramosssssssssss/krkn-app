...
const menuItems = [
  { id: 'instaladas', title: 'Instaladas', subtitle: 'Apps activas', icon: 'checkmark-circle-outline' },
  { id: 'tienda', title: 'Tienda', subtitle: 'Apps disponibles', icon: 'storefront-outline' },
  { id: 'configuracion', title: 'Configuración', subtitle: 'Ajustes de apps', icon: 'settings-outline' },
];
