...
const mockModules = [
  { id: 'conversaciones', title: 'Conversaciones', subtitle: 'Chats activos', icon: 'chatbubbles-outline' },
  { id: 'grupos', title: 'Grupos', subtitle: 'Conversaciones grupales', icon: 'people-outline' },
  { id: 'notificaciones', title: 'Notificaciones', subtitle: 'Alertas y avisos', icon: 'notifications-outline' },
  { id: 'archivados', title: 'Archivados', subtitle: 'Chats archivados', icon: 'archive-outline' },
  { id: 'broadcast', title: 'Broadcast', subtitle: 'Mensajes masivos', icon: 'megaphone-outline' },
];
      ...
      {Platform.OS === 'ios' ? (
        <BlurView intensity={50} tint="dark" style={styles.fullscreenBlur}>
          <View style={styles.mysteryContent}>
            ...
            <Text style={styles.mysteryTitle}>Chats</Text>
