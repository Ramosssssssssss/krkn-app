...
// Color principal para Salidas (rojo oscuro)
const SALIDAS_COLOR = '#B71C1C';
...
export default function CrearSalidaScreen() {
  ...
  const handleConfirmSave = () => {
    ...
    Alert.alert('Éxito', `Salida guardada con ${totalArticulos} artículos (${totalUnidades} unidades)`, [
    ...
    return (
      ...
      >
        <View style={styles.articleInfo}>
          <Text style={[styles.articleClave, { color: SALIDAS_COLOR }]}>{item.clave}</Text>
        ...
        <View style={styles.articleActions}>
          <View style={styles.quantityControl}>
            ...
            <TouchableOpacity 
              style={[styles.qtyBtn, { backgroundColor: SALIDAS_COLOR }]}
              onPress={() => handleUpdateQuantity(item._key, 1)}
            >
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
          ...
          headerRight: () => (
            <TouchableOpacity 
              style={[
                ...
                { backgroundColor: aggressiveScan ? `${SALIDAS_COLOR}25` : 'transparent' }
              ]}
            ...
            >
              <Ionicons 
                ...
                size={20} 
                color={aggressiveScan ? SALIDAS_COLOR : colors.textSecondary} 
              />
            </TouchableOpacity>
          ),
        }}
      ...
      <View style={[styles.searchBar, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
        <View style={[styles.searchInputWrapper, { backgroundColor: colors.background, borderColor: aggressiveScan ? SALIDAS_COLOR : colors.border }]}>
          <Ionicons name="barcode-outline" size={18} color={aggressiveScan ? SALIDAS_COLOR : colors.textSecondary} />
          <TextInput
            ref={searchInputRef}
          ...
          />
          {isSearching ? (
            <ActivityIndicator size="small" color={SALIDAS_COLOR} />
          ) : searchQuery.length > 0 ? (
            <TouchableOpacity onPress={() => setSearchQuery('')}>
              <Ionicons name="close-circle" size={18} color={colors.textTertiary} />
            </TouchableOpacity>
          ) : aggressiveScan && (
            <View style={[styles.scanIndicator, { backgroundColor: SALIDAS_COLOR }]} />
          )}
        ...
        {!aggressiveScan && searchQuery.trim() && (
          <TouchableOpacity
            style={[styles.addBtn, { backgroundColor: SALIDAS_COLOR }]}
      ...
      >
        <Ionicons name="location" size={14} color={SALIDAS_COLOR} />
      ...
      {detalles.length > 0 ? (
        ...
        <View style={styles.emptyState}>
          <View style={[styles.emptyIcon, { backgroundColor: `${SALIDAS_COLOR}15` }]}>
            <Ionicons name="scan-outline" size={48} color={SALIDAS_COLOR} />
          </View>
          ...
          <View style={[styles.locationModalContent, { backgroundColor: colors.surface }]}>
                ...
                {sucursales.map((suc) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      { backgroundColor: colors.background, borderColor: selectedSucursal === suc.id ? SALIDAS_COLOR : colors.border },
                  ...
                  >
                    <Ionicons 
                      ...
                      size={20} 
                      color={selectedSucursal === suc.id ? SALIDAS_COLOR : colors.textSecondary} 
                    />
                    <Text style={[styles.locationOptionText, { color: selectedSucursal === suc.id ? SALIDAS_COLOR : colors.text }]}>
                      {suc.nombre}
                    </Text>
                    {selectedSucursal === suc.id && (
                      <Ionicons name="checkmark-circle" size={20} color={SALIDAS_COLOR} />
                    )}
                  </TouchableOpacity>
                ))}
              </View>
                ...
                <View style={styles.fieldGroup}>
                  ...
                  {almacenesFiltrados.map((alm) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.locationOption,
                        { backgroundColor: colors.background, borderColor: selectedAlmacen === alm.id ? SALIDAS_COLOR : colors.border },
                    ...
                    >
                      <Ionicons 
                        name="cube-outline" 
                        size={20} 
                        color={selectedAlmacen === alm.id ? SALIDAS_COLOR : colors.textSecondary} 
                      />
                      <Text style={[styles.locationOptionText, { color: selectedAlmacen === alm.id ? SALIDAS_COLOR : colors.text }]}>
                        {alm.nombre}
                      </Text>
            ...
            {selectedSucursal && selectedAlmacen && (
              <View style={[styles.locationModalFooter, { borderTopColor: colors.border }]}>
                <TouchableOpacity
                  style={[styles.locationConfirmBtn, { backgroundColor: SALIDAS_COLOR }]}
      ...
      >
        <View style={styles.summaryModalOverlay}>
          <View style={[styles.summaryModalContent, { backgroundColor: colors.surface }]}>
            <View style={[styles.summaryModalHeader, { backgroundColor: SALIDAS_COLOR }]}>
            ...
            <View style={styles.summaryModalBody}>
              ...
              <View style={styles.summaryRow}>
                ...
                <Text style={[styles.summaryValueBig, { color: SALIDAS_COLOR }]}>{totalArticulos}</Text>
              </View>
              <View style={styles.summaryRow}>
                <Text style={[styles.summaryLabel, { color: colors.textSecondary }]}>Unidades totales</Text>
                <Text style={[styles.summaryValueBig, { color: SALIDAS_COLOR }]}>{totalUnidades}</Text>
              </View>
            </View>
            ...
            <View style={styles.summaryModalFooter}>
              ...
              <TouchableOpacity
                style={[styles.summaryBtn, styles.summaryConfirmBtn, { backgroundColor: SALIDAS_COLOR }]}
