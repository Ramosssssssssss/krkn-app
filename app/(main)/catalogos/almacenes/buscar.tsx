...
export default function BuscarAlmacenesScreen() {
  ...
  const { sucursales, almacenes, isLoading, error, refresh } =
  ...
  const richWarehouses: AlmacenRich[] = useMemo(() => {
    return almacenes.map((alm) => {
      ...
      const sucursalNombre =
        sucursales.find((s) => s.id === alm.sucursalId)?.nombre ||
        "Sin Sucursal";
          ...
          >
            <View
              style={[
                ...
                { width: `${item.ocupacion}%`, backgroundColor: occColor },
              ]}
            />
          </View>
          <Text style={[styles.capacityText, { color: colors.textTertiary }]}>
            {Math.round((item.capacidad * item.ocupacion) / 100)} /{" "}
            {item.capacidad} m³
          </Text>
        </View>
    ...
    return (
      ...
      >
        ...
        <View style={[styles.gridBadge, { backgroundColor: `${occColor}20` }]}>
          <Text style={[styles.gridBadgeText, { color: occColor }]}>
            {item.ocupacion}%
          </Text>
        </View>
  ...
  if (error && !almacenes.length) {
    return (
      ...
      >
        <View
          style={[styles.errorIcon, { backgroundColor: `${colors.error}15` }]}
        >
          <Ionicons
              ...
              {[0, 1, 2].map((i) => (
                ...
                >
                  ...
                  <View style={styles.productRow}>
                    <Bone width={48} height={48} radius={8} />
                    <View style={{ flex: 1, gap: 6 }}>
                      <Bone width={140} height={14} radius={4} />
                  ...
                  {/* Details row */}
                  <View style={styles.detailsRow}>
                    <View style={[styles.detailItem, { gap: 6 }]}>
                      <Bone width={36} height={8} radius={3} />
                      <Bone width={60} height={12} radius={3} />
                    </View>
                    <View style={[styles.detailItem, { gap: 6 }]}>
                      <Bone width={50} height={8} radius={3} />
                      <Bone width={80} height={12} radius={3} />
                    </View>
                    <View style={[styles.detailItem, { gap: 6 }]}>
                      <Bone width={54} height={8} radius={3} />
                      <Bone width={36} height={12} radius={3} />
                    </View>
                  </View>
                  <View
                    style={[styles.divider, { backgroundColor: colors.border }]}
                  ...
                  <View style={styles.progressSection}>
                    ...
                    <Bone width={100} height={8} radius={3} />
                  </View>
                  <View
                    style={[styles.divider, { backgroundColor: colors.border }]}
                  />
                  ...
                  >
                    ...
                    />
                    <Bone width={70} height={14} radius={4} />
                  </View>
                </View>
              ))}
            </View>
