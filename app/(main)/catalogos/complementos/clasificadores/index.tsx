...
export default function ClasificadoresScreen() {
  ...
  const filteredItems = MOCK_CLASIFICADORES.filter(
    (item) =>
      ...
      {filteredItems.map((item) => (
        ...
        >
          ...
          <View>
            ...
            <Text style={[s.cardCode, { color: colors.textTertiary }]}>
              {item.codigo}
            </Text>
          </View>
    ...
    <View style={[s.container, { backgroundColor: colors.background }]}>
      ...
      {!loading && (
        <Text style={[s.countBadge, { color: colors.textTertiary }]}>
          ...
          {filteredItems.length === 1 ? "clasificador" : "clasificadores"}
