/**
 * DraftResumeModal — Pregunta si desea continuar con un conteo en curso.
 */
import { useThemeColors } from "@/context/theme-context";
import { ConteoDraft } from "@/hooks/use-conteo-draft";
...
export default function DraftResumeModal({
  ...
  const totalUnidades = draft.detalles.reduce((sum, d) => sum + d.cantidad, 0);
      ...
      <View style={st.overlay}>
        <View style={[st.content, { backgroundColor: colors.surface }]}>
          ...
          <Text style={[st.subtitle, { color: colors.textSecondary }]}>
            Tienes un conteo sin guardar de hace {timeAgo}. ¿Deseas continuar
            donde te quedaste?
          </Text>
          ...
          >
            ...
            <Text style={st.primaryBtnText}>Continuar conteo</Text>
          </TouchableOpacity>
